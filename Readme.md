...
![GitHub top language](https://img.shields.io/github/languages/top/emmanuelmarcosdeoliveira/convert?style=plastic&labelColor=%23000)
![GitHub language count](https://img.shields.io/github/languages/count/emmanuelmarcosdeoliveira/convert?style=flat&logo=github&logoColor=%23fff&logoSize=auto&labelColor=%23000)
![GitHub repo size](https://img.shields.io/github/repo-size/emmanuelmarcosdeoliveira/convert?style=plastic&logo=github&logoColor=%23fff&logoSize=auto&labelColor=%23000)
![GitHub forks](https://img.shields.io/github/forks/emmanuelmarcosdeoliveira/convert?style=plastic&labelColor=%23000)
...
**Convert** é uma aplicação JavaScript para conversão de moedas.<br>
Éla faz conversão de valores de acordo com a moeda selecionada.  
...
- Desenvolver uma aplicação para converter valores monetários

`Charlenge`

Fazer a utilização de `JavaScript` para fazer a conversão de valores<br>

### Functionalities

- [x] **Conversão de Real - Dólar Americano**
- [x] **Conversão de Real - Euro**
- [x] **Conversão de Real - Libra**
...
```bash
git clone https://convert-ofs.vercel.app/
```
...
<img src="./src//assets/github/convert.png" alt="imagem projeto Convert | Emmanuel Oliveira" >
...
<br>
<br>
<a href="https://convert-ofs.vercel.app/">
...
[`voltar ao topo`](#-convert--conversor-de-moedas)
